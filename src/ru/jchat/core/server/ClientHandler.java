...
//                                System.out.println(nick);
                    ...
                    while (!Thread.currentThread().isInterrupted()) {
                        ...
                        if (inMessage.getType() == Message.BYE_BYE_MESSAGE) {
                            ...
                            if (inMessage.getText().substring(4).contains(" ")) sendMsg(new Message(Message.PRIVATE_SERVICE_MESSAGE, "Nick cannot contain spaces", new Date()));
                            else if (inMessage.getText().substring(4).equals("")) sendMsg(new Message(Message.PRIVATE_SERVICE_MESSAGE, "Nick cannot be empty", new Date()));
                            else {
